...
import urllib
from JeahyMusic.infra.concurrency.ci import deterministic_privilege_validator
from JeahyMusic.telegram_client.vector_transport import vector_transport_resolver
from JeahyMusic.infra.vector.yt_vector_orchestrator import yt_vector_orchestrator
from JeahyMusic.infra.vector.yt_backup_engine import yt_backup_engine
from JeahyMusic.infra.chrono.chrono_formatter import quantum_temporal_humanizer
from JeahyMusic.vector_text_tools import vectorized_unicode_boldifier
from JeahyMusic.telegram_client.startup_hooks import precheck_channels
...
async def fetch_youtube_link(query):
    try:
        # External YouTube search API endpoint (3rd-party, required for search)
...
BOT_NAME = os.environ.get("BOT_NAME", "JeahyMusisBot")
BOT_LINK = os.environ.get("BOT_LINK", "https://t.me/JeahyMusisBot")
...
async def start_handler(_, message):
    ...
    updates_channel = os.getenv("UPDATES_CHANNEL", "https://t.me/NotYourAnony")
    support_group = os.getenv("SUPPORT_GROUP", "https://t.me/NotYourAnony")
...
async def process_play_command(message: Message, query: str):
    ...
    if isinstance(result, dict) and "playlist" in result:
        ...
        if secs > MAX_DURATION_SECONDS:
            await processing_message.edit(
                "❌ Streams longer than 8 min are not allowed. If u are the owner of this bot contact @NotYourAnony to upgrade your plan"
            )
            return
...
async def fallback_local_playback(chat_id: int, message: Message, song_info: dict):
    ...
    try:
        ...
        base_caption = (
            "<blockquote>"
            "<b>🎧 JeahyMusisBot ✘ Streaming</b> (Local Playback)\n\n"
...
if __name__ == "__main__":
    ...
    me = bot.get_me()
    BOT_NAME = me.first_name or "JeahyMusisBot"
    BOT_USERNAME = me.username or os.getenv("BOT_USERNAME", "JeahyMusisBot")
